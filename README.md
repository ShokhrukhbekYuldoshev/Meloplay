...
| [package_info_plus](https://pub.dev/packages/package_info_plus)                       | 8.1.0         | Flutter plugin for querying information about the application package, such as CFBundleVersion on iOS or versionCode on Android.                                         |
...
| [share_plus](https://pub.dev/packages/share_plus)                                     | 10.1.1        | Flutter plugin for sharing content via the platform share UI, using the ACTION_SEND intent on Android and UIActivityViewController on iOS.                               |
